 ...
 *   llm.js, semantic-ui.js, executors.js, recovery.js and the external
        ...
        if (!blocker.blocked) {
          ...
          if (located.code === "SURFACE_NOT_OBSERVABLE") {
            console.log(
              ...
              `| capability=result-content.observe | backend=computer-control`
            );
          }
...
async function main() {
  // The application owns the external Computer Control runtime session it
  // opens. All exit paths converge on the same synchronous cleanup handler.
  ...
  console.log("");
  console.log("RumiAI Computer Use");
  console.log(
